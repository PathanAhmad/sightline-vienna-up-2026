...
What's on screen right now:
  ...
  - On the right rail there are a few sections: "JUMP TO A TYPICAL CATCH" (shortcuts to common issues), a small "CATCHES" grid (counts of specific problems we caught -- duplicate photos, geo-mismatches, GDPR redactions, signs of tampering), and two action buttons at the bottom: "Download deficiency report" (opens a menu to grab either the raw CSV or a print-friendly HTML for the crew) and "Ask QC bot" (you).
